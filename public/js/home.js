...
// laoding
let lineLoading = document.querySelector(".loading-line");
let headerLoading = document.querySelector(".loading-header")
let hidder= document.querySelector(".hidder")
let textLoading= document.querySelector(".loading-text")

let loaderContainer = document.querySelector(".black-start");


window.addEventListener("load", ()=>{

    lineLoading.style.scale = "1";

    setTimeout(() => {
        headerLoading.style.opacity="1";
        headerLoading.style.transform="translateY(0)"


        setTimeout(() => {

            hidder.style.zIndex="140"
            lineLoading.style.zIndex="140"
            hidder.style.top="-8vw"

            textLoading.style.opacity="1";

            textLoading.style.transform = "translateY(0)"
